...
// Your router for /api/tokocinas
const tokocinasRouter = express.Router();
tokocinasRouter.post('/', (req, res) => {
  res.send('POST request to /api/tokocinas');
});

// Mount the router
app.use('/api/tokocinas', tokocinasRouter);
